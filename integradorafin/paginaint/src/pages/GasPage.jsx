...
function GasPage() {
    ...
    const [datosFiltrados, setDatosFiltrados] = useState([]); // Agrega el estado para los datos filtrados
    ...
    const mostrarUltimoNivel = () => {
        const ultimoNivel = historialOrdenado.length > 0 ? historialOrdenado[historialOrdenado.length - 1] : null;
        if (ultimoNivel) {
            Swal.fire({
    ...
    return (
        <div>
            ...
            <div style={styles.container}>
                <h2 style={styles.title}>Registro de fugas de Gas</h2>
