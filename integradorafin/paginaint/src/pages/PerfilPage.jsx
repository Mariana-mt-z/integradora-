    ...
    const handleDelete = async () => {
        try {
            ...
            if (result.isConfirmed) {
                ...
                navigate('/'); // redirecciona a pagina de inicio 
            }
        } catch (error) {
...
// Estilos para formulario y y título
const styles = {
    profileTitle: {
        marginTop: '0rem',
        marginBottom: '0rem', 
    ...
    deleteButton: {
        backgroundColor: 'red', // Color de fondo rojo para el botón de eliminar
    },
    iconContainer: {
        width: '80px', // Ajusta el tamaño del contenedor del icono
        height: '80px',
    },
    userIcon: {
