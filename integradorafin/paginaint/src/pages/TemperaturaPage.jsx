...
import { filtrarFechas } from '../components/fechas/operacion'; // Asegúrate de importar la función de filtrado de fechas
...
const TemperaturaPage = () => {
    ...
    const [datosFiltrados, setDatosFiltrados] = useState([]); // Estado para almacenar los datos filtrados por fechas
    ...
    const handleFiltrarClick = () => {
        ...
        setCurrentPage(1); // Reiniciar la página actual a 1 después de aplicar los filtros
    };
    const styles = {
        container: {
            padding: '20px',
    ...
    return (
        <div>
            ...
            <div style={styles.container}>
                <h2 style={styles.title}>Registro de Temperatura y Humedad</h2>
                <div style={{ textAlign: 'center', marginBottom: '20px' }}>
                    <button onClick={mostrarUltimoRegistro} style={styles.button}>
                        Ver Último Registro
                    </button>
                </div>
                {/* Agrega el componente de filtrado por fechas */}
